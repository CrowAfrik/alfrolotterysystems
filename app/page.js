          ...
          <div className="grid lg:grid-cols-2 gap-4 lg:mt-32 mt-16 sm:grid-cols-1 md:grid-cols-2 text-grey-900">
            <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 mt-10 ">
                ...
                <a className="text-white mt-4 font-light  text-center px-3 py-5 border  rounded-3xl border-white  hover:bg-red-800 hover:text-white " href="https://drive.google.com/file/d/1xv2v4WJZ6MUVndt5mRSQRq_GXKD-8Kni/view?usp=sharing" target="_blank">Download ALS App (Android)</a>
                </div>
                ...
                <a className="text-white mt-4 font-light  text-center px-16 md:px-12 py-5 border  rounded-3xl border-white  hover:bg-red-800 hover:text-white " href="https://drive.google.com/file/d/1Sv2vIEADbp8TVlv2eFZOi9Jb53d0f_8u/view?usp=sharing" target="_blank">ALS Kiosk App</a>
                </div>
              </div>
